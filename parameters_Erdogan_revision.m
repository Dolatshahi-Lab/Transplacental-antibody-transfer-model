%% Code containing parameters for Erdogan 2023. %%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Any of these parameters can be modified to explore their effect on IgG transfer.
...
x0 = [p.igg1,p.igg2,p.igg3,p.igg4,zeros(1,31)];

%% Extract kon (rate of forward reaction) and koff (rate of reverese reaction)
%% from KD values. %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
